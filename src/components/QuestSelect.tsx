...
const QUESTS: QuestCard[] = [
  ...
  {
    id: 'photo-social',
    title: 'Build Instagram',
    emoji: '📸',
    description: 'Scale a photo-sharing platform: feeds, media delivery, ranking, notifications, and discovery.',
    topics: 'Fan-out · CDN · Feed Ranking · Push Notifs · Async Pipeline · Graph Discovery',
    gradient: 'from-pink-50 to-rose-50',
    borderColor: 'border-pink-200',
    buttonClass: 'bg-pink-500 hover:bg-pink-600 shadow-lg shadow-pink-200',
    resumeButtonClass: 'bg-pink-100 hover:bg-pink-200 text-pink-700 border border-pink-300',
  },
];
